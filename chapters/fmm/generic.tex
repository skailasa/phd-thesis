...
The notion of admissability is made more concrete by reference to a data structure chosen to discretise the problem.

- For FMM, Octree, but alternatives include ORB.

- princiapply, just need a way of encoding the geometry of the problem to be able to define admissability.

- as we will see, by choosing an appropriate scheme for creating octrees, one can achieve O(1) lookup times for data associated with octants.
